...
All the functions and classes needed for the lab are provided as templates, and you will implement them as described in the <LAB MANUAL>. Before working on the code, it is recommended to execute the run.py and make sure you get the following results.
...
<TASK 1> Here you will create a Restricted Boltzmann Machine, implement the inference rules, and learn the parameters with contrastive divergence. You would have to work on the following functions :
...
<TASK 3> Here you will implement the wake-sleep algorithm to fine-tune all the parameters of the DBN. You would also have to implement new RBM methods for learning directed connections. You would have to work on the following functions:
